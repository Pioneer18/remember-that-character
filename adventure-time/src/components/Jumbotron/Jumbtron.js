    ...
    render() {
        ...
        return (
            ...
            <Mobile>
             <div style={height} className="jumbotron">
                    <div className="container">
                    <span style={{fontSize: "3rem"}} className="top">Adventure Time Memory game</span>

                    <br/>
                    
                    <span style={{fontSize: "2rem"}} className="instructions">Try to select each of the 12 characters in a row 
            ...
            <Mini>
                <div style={height} className="jumbotron">
                    <div className="container">
                    <span style={{fontSize: "2.5rem"}} className="top">Adventure Time Memory game</span>

                    <br/>
                    
                    <span style={{fontSize: "1.8rem"}} className="instructions">Try to select each of the 12 characters in a row 
